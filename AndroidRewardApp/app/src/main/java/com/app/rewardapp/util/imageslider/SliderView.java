package com.app.rewardapp.util.imageslider;

import static com.app.rewardapp.util.imageslider.IndicatorView.draw.controller.AttributeController.getRtlMode;
...
import com.app.rewardapp.util.imageslider.IndicatorView.PageIndicatorView;
import com.app.rewardapp.util.imageslider.IndicatorView.animation.type.BaseAnimation;
import com.app.rewardapp.util.imageslider.IndicatorView.animation.type.ColorAnimation;
import com.app.rewardapp.util.imageslider.IndicatorView.animation.type.IndicatorAnimationType;
import com.app.rewardapp.util.imageslider.IndicatorView.draw.controller.DrawController;
import com.app.rewardapp.util.imageslider.IndicatorView.draw.data.Orientation;
import com.app.rewardapp.util.imageslider.IndicatorView.draw.data.RtlMode;
import com.app.rewardapp.util.imageslider.IndicatorView.utils.DensityUtils;
import com.app.rewardapp.util.imageslider.InfiniteAdapter.InfinitePagerAdapter;
import com.app.rewardapp.util.imageslider.Transformations.AntiClockSpinTransformation;
import com.app.rewardapp.util.imageslider.Transformations.Clock_SpinTransformation;
import com.app.rewardapp.util.imageslider.Transformations.CubeInDepthTransformation;
import com.app.rewardapp.util.imageslider.Transformations.CubeInRotationTransformation;
import com.app.rewardapp.util.imageslider.Transformations.CubeInScalingTransformation;
import com.app.rewardapp.util.imageslider.Transformations.CubeOutDepthTransformation;
import com.app.rewardapp.util.imageslider.Transformations.CubeOutRotationTransformation;
import com.app.rewardapp.util.imageslider.Transformations.CubeOutScalingTransformation;
import com.app.rewardapp.util.imageslider.Transformations.DepthTransformation;
import com.app.rewardapp.util.imageslider.Transformations.FadeTransformation;
import com.app.rewardapp.util.imageslider.Transformations.FanTransformation;
import com.app.rewardapp.util.imageslider.Transformations.FidgetSpinTransformation;
import com.app.rewardapp.util.imageslider.Transformations.GateTransformation;
import com.app.rewardapp.util.imageslider.Transformations.HingeTransformation;
import com.app.rewardapp.util.imageslider.Transformations.HorizontalFlipTransformation;
import com.app.rewardapp.util.imageslider.Transformations.PopTransformation;
import com.app.rewardapp.util.imageslider.Transformations.SimpleTransformation;
import com.app.rewardapp.util.imageslider.Transformations.SpinnerTransformation;
import com.app.rewardapp.util.imageslider.Transformations.TossTransformation;
import com.app.rewardapp.util.imageslider.Transformations.VerticalFlipTransformation;
import com.app.rewardapp.util.imageslider.Transformations.VerticalShutTransformation;
import com.app.rewardapp.util.imageslider.Transformations.ZoomOutTransformation;
