...
import com.app.rewardapp.util.imageslider.IndicatorView.animation.data.type.ColorAnimationValue;
import com.app.rewardapp.util.imageslider.IndicatorView.animation.data.type.DropAnimationValue;
import com.app.rewardapp.util.imageslider.IndicatorView.animation.data.type.FillAnimationValue;
import com.app.rewardapp.util.imageslider.IndicatorView.animation.data.type.ScaleAnimationValue;
import com.app.rewardapp.util.imageslider.IndicatorView.animation.data.type.SwapAnimationValue;
import com.app.rewardapp.util.imageslider.IndicatorView.animation.data.type.ThinWormAnimationValue;
import com.app.rewardapp.util.imageslider.IndicatorView.animation.data.type.WormAnimationValue;
